"""DG-Dubs domain models.

Doubles tournament rating system: players, tournaments, teams,
rating history, ace pot, and seasons.
"""
...
class Tournament(db.Model):
    ...
    ace_pot_paid_to = db.Column(db.String(500), nullable=True)
